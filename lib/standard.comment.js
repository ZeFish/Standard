(function () {
   ...
   * GitHub Comments
   *
   * HTMX-COMPATIBLE VERSION: Includes a robust event listener
   ...
   * Default export
   */
  // export default comments; // Removed for IIFE compatibility

  /**
   * Export the class for advanced usage
   */
  // export { GitHubComments }; // Removed for IIFE compatibility
  ...
  // Export for module systems if needed (though this is wrapped in IIFE)
