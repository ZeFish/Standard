---
title: Markdown Plugin with Fine-Art Typography
layout: base
permalink: /docs/markdown-plugin-with-fine-art-typography/index.html
eleventyNavigation:
  key: Markdown Plugin with Fine-Art Typography
  parent: 11ty Plugins
  title: Markdown Plugin with Fine-Art Typography
...
# Markdown Plugin with Fine-Art Typography

Configures markdown-it parser with plugins for syntax highlighting, callout blocks, footnotes, and classical typography enhancements applied at build time.
