(function () {
  ...
  // from their respective global modules (standard.copy-buttons.js and standard.scroll-wrappers.js)
   ...
   */
  function setupAstroThemeSwitching() {
   ...
   */
  function setupAstroScrollManagement(options = {}) {
   ...
   */
  function setupAstroReinitialization() {
    if (typeof window === "undefined") return;
   ...
   */
  function setupAstroPageLoadReinitialization() {
    if (typeof window === "undefined") return;
   ...
   */
  function setupAstroDebugLogging() {
  ...
  if (typeof window !== "undefined") {
    window.initAstro = initAstro;
    window.astroHelpers = astroHelpers;
  }
